  ...
  return (
    <section className="relative flex h-[700px] flex-col items-center justify-center bg-stone-900 bg-[url('/images/unsplash-bg.jpg')] bg-cover bg-center bg-blend-overlay">
      <div className="flex flex-col items-center justify-center">
        <h1 className="mb-4 text-4xl font-semibold tracking-widest text-stone-50 md:text-5xl lg:text-6xl">
          Thrasher Landing
        </h1>

        <div className="lineAnimation mx-auto w-[200px] bg-stone-100 underline"></div>

        <p className="mt-4 text-center  font-sans text-xs font-extralight tracking-[1.5px] text-stone-200 md:text-sm lg:text-base">

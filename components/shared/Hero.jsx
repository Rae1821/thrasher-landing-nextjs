  ...
  return (
    ...
    <section className="h-[700px] relative flex flex-col justify-center items-center bg-stone-900 bg-[url('/images/unsplash-bg.jpg')] bg-cover bg-center bg-blend-overlay">
        <div className="flex flex-col justify-center items-center">
            <h1 className="playfair text-stone-50 text-4xl md:text-5xl lg:text-6xl tracking-widest mb-4">Thrasher Landing</h1>

                <div className="underline bg-stone-100 mx-auto"></div>

                    <p className="font-mont font-extralight  tracking-[1.5px] text-stone-200 text-sm lg:text-xl text-center mt-4 uppercase">Welcome home neighbor</p>
        </div>
        <div className="flex flex-col md:flex-row items-center gap-4 mt-10">
                <Button asChild className="bg-stone-400 text-black border-stone-400 hover:bg-stone-300 hover:transition-all hover:ease-out hover:duration-150">

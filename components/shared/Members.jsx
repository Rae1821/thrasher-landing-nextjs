...
const Members = () => {
  return (
    <section id="about" className="pb-4 bg-gradient-to-t from-cyan-600 via-cyan-700 to-cyan-800 min-h-screen">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 grid-rows-4 mx-auto mt-16 lg:max-w-6xl">
          <div className="p-4 text-center flex gap-2 items-center w-72">
            <div className="avatar w-32 h-32 bg-cyan-800 mx-auto"></div>
              <h3 className="font-sans font-black tracking-wide mt-4 text-3xl text-black text-left ">Greg
                <span className="block">Dooley</span>
                <span className="block font-normal uppercase tracking-wider text-sm">President</span>
              </h3>
          </div>
          <div className="p-4 text-center flex gap-2 items-center w-72 lg:col-start-2 lg:row-start-2">
            <div className="avatar w-32 h-32 bg-cyan-800 mx-auto "></div>
          ...
          <div className="p-4 text-center flex gap-2 items-center w-72 lg:col-start-3 lg:row-start-3">
            <div className="avatar w-32 h-32 bg-cyan-800 mx-auto "></div>
          ...
          <div className="p-4 text-center flex gap-2 items-center w-72 lg:col-start-4 lg:row-start-4">
            <div className="avatar w-32 h-32 bg-cyan-800 mx-auto "></div>
